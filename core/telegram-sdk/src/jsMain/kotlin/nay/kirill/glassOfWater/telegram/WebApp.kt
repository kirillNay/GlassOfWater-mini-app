...
import nay.kirill.glassOfWater.telegram.buttons.BackButton
import nay.kirill.glassOfWater.telegram.buttons.MainButton
import nay.kirill.glassOfWater.telegram.data.WebAppInitData
import nay.kirill.glassOfWater.telegram.popup.PopupParams
import kotlin.coroutines.resume
import kotlin.coroutines.suspendCoroutine

val webApp: WebApp get() = WebApp(js("window.Telegram.WebApp"))
...
class WebApp internal constructor(
     ...
     */
    val rawInitData: String = jsDelegate.initData
     ...
     */
    val initDataUnsafe: WebAppInitData = jsDelegate.initDataUnsafe

    /**
     * The version of the Bot API available in the user's Telegram app.
     */
    val version: String = jsDelegate.version

    /**
     * The name of the platform of the user's Telegram app.
     */
    val platform: String = jsDelegate.platform
     ...
     */
    val colorScheme: String = jsDelegate.colorScheme

    /**
     * An object containing the current theme settings used in the Telegram app.
     */
    val themeParams: ThemeParams = jsDelegate.themeParams
     ...
     */
    val isExpanded: Boolean = jsDelegate.isExpanded
     ...
     */
    val viewportHeight: Float = jsDelegate.viewportHeight
     ...
     */
    val viewportStableHeight: Float = jsDelegate.viewportStableHeight

    /**
     * Current header color in the #RRGGBB format.
     */
    val headerColor: String = jsDelegate.headerColor

    /**
     * Current background color in the #RRGGBB format.
     */
    val backgroundColor: String = jsDelegate.backgroundColor
     ...
     */
    val isClosingConfirmationEnabled: Boolean = jsDelegate.isClosingConfirmationEnabled

    /**
     * An object for controlling the back button which can be displayed in the header of the Mini App in the Telegram interface.
     */
    val backButton: BackButton = jsDelegate.backButton

    /**
     * An object for controlling the main button, which is displayed at the bottom of the Mini App in the Telegram interface.
     */
    val mainButton: MainButton = jsDelegate.mainButton

    /**
     * An object for controlling haptic feedback.
     */
    val hapticFeedback: HapticFeedback = jsDelegate.hapticFeedback

    /**
     * An object for controlling cloud storage.
     */
    val cloudStorage: CloudStorage = CloudStorage(jsDelegate.cloudStorage)
